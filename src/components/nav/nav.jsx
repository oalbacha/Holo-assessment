...
const Nav = () => {
  ...
  return (
    <StyledNav inputValue={debouncedSearchTerm}>
      <div className='App-title-container'>
        <svg className='App-logo' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <div className='App-title-content'>
          <h3 className='App-title'>GitHub Searcher</h3>
          <p className='App-subtitle'>Search users or repositories below</p>
        </div>
      </div>
      ...
      <div className='App-nav-controls'>
        <input
          className='App-input'
          placeholder='Search starts at 4 characters'
          type="text"
          name="searchTerm"
          id="searchTerm"
          value={inputValue}
